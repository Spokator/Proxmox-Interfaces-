...
# ═══════════════════════════════════════════════════════════════
#  create-container.sh
#  Crée le conteneur LXC CT 107 pour Chretieno.lan sur Proxmox
...
# ─── Configuration ────────────────────────────────────────────
CT_ID=107
CT_NAME="chretieno-intranet"
CT_IP="192.168.8.107/24"
CT_GW="192.168.8.1"
CT_DNS="192.168.8.150"          # DNS Technitium
CT_BRIDGE="vmbr0"
CT_CORES=1
CT_RAM=512
CT_SWAP=512
...
CT_PASSWORD="ChretienoLan2024!" # ← CHANGEZ CE MOT DE PASSE
...
echo -e "\n${BLUE}╔══════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║  Chretieno.lan — Création CT ${CT_ID}         ║${NC}"
echo -e "${BLUE}╚══════════════════════════════════════════╝${NC}\n"
...
echo -e "     ${BLUE}scp -r /chemin/vers/Chretieno.lan root@${CT_IP%/*}:/opt/chretieno${NC}"
echo -e "  2. Exécutez le script d'installation :"
echo -e "     ${BLUE}ssh root@${CT_IP%/*} 'bash /opt/chretieno/deploy/install.sh'${NC}"
echo ""
